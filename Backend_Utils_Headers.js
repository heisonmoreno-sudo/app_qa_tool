...
var HEADER_ALIASES = {
  ...
  FechaCreacion: ['FechaCreacion', 'Fecha Creacion', 'FechaCreación', 'Fecha Creación'],
  CreadoPor: ['CreadoPor', 'Creado Por'],
  FechaUltimaEjecucion: ['FechaUltimaEjecucion', 'Fecha Última Ejecucion', 'Fecha Última Ejecución', 'FechaUltimaEjecución'],
  ResultadoUltimaEjecucion: ['ResultadoUltimaEjecucion', 'Resultado Última Ejecucion', 'Resultado Última Ejecución', 'EstadoEjecucion', 'EstadoEjecución'],
  ComentariosEjecucion: ['ComentariosEjecucion', 'Comentarios Ejecucion', 'Comentarios Ejecución'],
